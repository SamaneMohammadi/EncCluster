...
static inline bool binary_fuse8_serialize(binary_fuse8_t* obj, uint8_t* buffer) {

  memcpy(buffer, &obj->Seed, sizeof(obj->Seed));
  buffer += sizeof(obj->Seed);

  memcpy(buffer, &obj->SegmentLength, sizeof(obj->SegmentLength));
  buffer += sizeof(obj->SegmentLength);

  memcpy(buffer, &obj->SegmentLengthMask, sizeof(obj->SegmentLengthMask));
  buffer += sizeof(obj->SegmentLengthMask);

  memcpy(buffer, &obj->SegmentCount, sizeof(obj->SegmentCount));
  buffer += sizeof(obj->SegmentCount);

  memcpy(buffer, &obj->SegmentCountLength, sizeof(obj->SegmentCountLength));
  buffer += sizeof(obj->SegmentCountLength);

  memcpy(buffer, &obj->ArrayLength, sizeof(obj->ArrayLength));
  buffer += sizeof(obj->ArrayLength);

  memcpy(buffer, obj->Fingerprints, obj->ArrayLength);

  return true;
}

// Deserialization function
void binary_fuse8_deserialize(uint8_t* buffer, binary_fuse8_t* obj) {

  memcpy(&obj->Seed, buffer, sizeof(obj->Seed));
  buffer += sizeof(obj->Seed);

  memcpy(&obj->SegmentLength, buffer, sizeof(obj->SegmentLength));
  buffer += sizeof(obj->SegmentLength);

  memcpy(&obj->SegmentLengthMask, buffer, sizeof(obj->SegmentLengthMask));
  buffer += sizeof(obj->SegmentLengthMask);

  memcpy(&obj->SegmentCount, buffer, sizeof(obj->SegmentCount));
  buffer += sizeof(obj->SegmentCount);

  memcpy(&obj->SegmentCountLength, buffer, sizeof(obj->SegmentCountLength));
  buffer += sizeof(obj->SegmentCountLength);

  memcpy(&obj->ArrayLength, buffer, sizeof(obj->ArrayLength));
  buffer += sizeof(obj->ArrayLength);

  memcpy(obj->Fingerprints, buffer, obj->ArrayLength);
}
...
// Serialization function
static inline bool binary_fuse16_serialize(binary_fuse16_t* obj, uint8_t* buffer) {
  ...
  memcpy(buffer, obj->Fingerprints, obj->ArrayLength * sizeof(uint16_t));

  return true;
}

// Deserialization function
void binary_fuse16_deserialize(uint8_t* buffer, binary_fuse16_t* obj) {
  ...
  memcpy(obj->Fingerprints, buffer, obj->ArrayLength * sizeof(uint16_t));
}
