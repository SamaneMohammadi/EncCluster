...
all_src = ""
with open(f"{os.path.dirname(os.path.abspath(__file__))}/lib/xorfilter.h", "r", encoding='utf-8') as src:
  all_src += src.read()

with open(f"{os.path.dirname(os.path.abspath(__file__))}/lib/binaryfusefilter.h", "r", encoding='utf-8') as src:
  all_src += src.read()
...
bool xor8_serialize(xor8_t* obj, uint8_t* buffer);
bool binary_fuse8_serialize(binary_fuse8_t* obj, uint8_t* buffer);
bool xor16_serialize(xor16_t* obj, uint8_t* buffer);
bool binary_fuse16_serialize(binary_fuse16_t* obj, uint8_t* buffer);
